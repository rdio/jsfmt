...
var doc = [
  'Usage:',
  '  jsfmt [--no-format] [--ast] [--diff|--list|--write] [--validate] [--rewrite PATTERN|--search PATTERN] [--json|--in-ast] [<file>...]',
  '  jsfmt (--version | --help)',
  '',
  'Options:',
  ...
  '  -a --ast                       Output as JSON AST format',
  '  -i --in-ast                    Tell jsfmt the input is JSON AST format',
